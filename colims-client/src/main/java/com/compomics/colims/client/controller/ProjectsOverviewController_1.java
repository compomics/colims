 ...
 */
@Component("projectsOverviewController_1")
public class ProjectsOverviewController_1 {

    private static final Logger LOGGER = Logger.getLogger(ProjectsOverviewController_1.class);
    //model
    ...
    public ProjectsOverviewPanel_1 getProjectsOverviewPanel() {
        return projectsOverviewPanel;
    }

    public void init() {
        projectsOverviewPanel = new ProjectsOverviewPanel_1();
