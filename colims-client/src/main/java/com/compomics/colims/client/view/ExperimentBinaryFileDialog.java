...
public class ExperimentBinaryFileDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExperimentBinaryFileDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ExperimentBinaryFileDialog dialog = new ExperimentBinaryFileDialog(new javax.swing.JFrame(), true);
