 ...
 */
@Component("utilitiesPeptideMapper2")
public class UtilitiesPeptideMapper2 {

    /**
     * Logger instance.
     */
    private static final Logger LOGGER = Logger.getLogger(UtilitiesPeptideMapper2.class);
    /**
