 ...
 */
@Component("utilitiesProteinMapper2")
public class UtilitiesProteinMapper2 {

    /**
     * Logger instance.
     */
    private static final Logger LOGGER = Logger.getLogger(UtilitiesProteinMapper2.class);
    /**
