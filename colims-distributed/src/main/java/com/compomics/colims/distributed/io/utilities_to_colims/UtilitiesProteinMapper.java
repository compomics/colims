...
public class UtilitiesProteinMapper {
     ...
     *
     * @param proteinMatches    the map of utilities protein matches (key: ProteinMatch instance, value: PSParameter
     *                          instance)
        ...
        try {
            ...
            for (ProteinMatch proteinMatch : proteinMatches.keySet()) {
                ...
                if (proteinMatch != null) {
                    ...
                    //set scores
                    proteinGroup.setProteinProbability(proteinMatches.get(proteinMatch).getProteinProbabilityScore());
                    proteinGroup.setProteinPostErrorProbability(proteinMatches.get(proteinMatch).getProteinProbability());
