...
public class MaxQuantQuantificationSettingsParserTest {
    ...
    public void testCreateQuantificationReagent(){
        ...
        List<QuantificationMethodHasReagent> quantificationMethodHasReagents = maxQuantQuantificationSettingsParser.createQuantificationReagent(quantificationMethod, experimentLabel, reagents);
