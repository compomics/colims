...
/**
 * This class represents a modification entity in the database. This modification table is part of the identification
 * results. There is another modification table (search_modification), part of the search settings.
 *
