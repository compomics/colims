...
Download the colims client [here](http://genesis.ugent.be/colims/colims-client-1.3.2.zip) and the colims storage module [here](http://genesis.ugent.be/colims/colims-distributed-1.3.2.zip).
