...
/**
 * This interface provides methods for accessing the Ontology lookup service (OLS).
 *
...
public interface OlsService {
    ...
    /**
     * Retrieve ontologies by namespace. The namespaces are converted to lowercase before querying the OLS service.
    ...
    /**
     * Get the metadata before doing a paged search. If the ontology namespaces/the search fields are empty, the search
     * is performed against all ontologies/with the default search fields. This method is intended to be used in
     * combination with {@link #pagedSearch(java.lang.String, int, int) }
     *
     ...
     * @throws IOException              in case of an I/O related problem
     */
    List<OlsSearchResult> pagedSearch(String searchUrl, int startIndex, int pageSize) throws RestClientException, IOException;
