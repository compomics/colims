 ...
 * {@link MaxQuantEvidenceParser} and {@link MaxQuantMsmsParser} to handle specific files contained in the text folder.
 */
@Service
public class MaxQuantParser {
	...
	/**
	 * Parse a folder containing the MaxQuant txt output files, using the correct sub-parser for each known file type.
	 * 
