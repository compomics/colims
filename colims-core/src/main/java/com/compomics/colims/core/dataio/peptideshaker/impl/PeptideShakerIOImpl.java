package com.compomics.colims.core.dataio.peptideshaker.impl;
...
public class PeptideShakerIOImpl implements PeptideShakerIO {
    ...
    @Override
    public PeptideShakerImport unpackPeptideShakerCpsArchive(File peptideShakerCpsArchive) throws IOException, ArchiveException, ClassNotFoundException {
    ...
    @Override
    public PeptideShakerImport unpackPeptideShakerCpsArchive(File peptideShakerCpsArchive, File destinationDirectory) throws IOException, ArchiveException, ClassNotFoundException {
