...
/**
 * Parser for MaxQuant evidence.txt output files, that creates {@link Peptide}s, {@link Protein}s and
 * {@link Modification}s and links them with eachother and a argument {@link QuantificationGroup}. <br>
 * <br>
 * This class uses the {@link TabularFileLineValuesIterator} to actually parse the files into Map<String,String>
 * records. The {@link ProteinAccessioncodeParser} is used to retrieve the correct accessioncode to use from a String.
 */
@Service
public class MaxQuantEvidenceParser {
	...
	/**
	 * Parse the evidenceFile and add the peptides, proteins and modifications within to the quantificationGroup.
	 * 
	 * @param evidenceFile
