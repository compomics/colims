...
/**
 * Refer to headers in MaxQuant msms.txt output files by enum values, as headers
 * are likely to change with each new version of MaxQuant. Their order is also
 * likely to change between files regardless of MaxQuant version.
 */
enum MsmsHeaders {
