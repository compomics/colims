...
public class ColimsSpectrumMapper {
     ...
     * Logger instance.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ColimsSpectrumMapper.class);
    ...
    public MSnSpectrum map(final Spectrum sourceSpectrum) throws MappingException {
        ...
        //Add peaks
        for (SpectrumFile spectrumFile : sourceSpectrum.getSpectrumFiles()) {
            try {
                Map<Double, Double> mzAndIntensities = spectrumService.getSpectrumPeaks(spectrumFile);
