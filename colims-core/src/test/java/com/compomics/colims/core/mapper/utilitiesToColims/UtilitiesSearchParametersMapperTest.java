...
public class UtilitiesSearchParametersMapperTest {
    ...
    public void testMap() throws Exception {
        ...
        PeptideShakerImport imported = peptideShakerIO.unpackPeptideShakerCpsArchive(new ClassPathResource("data/peptideshaker/test_peptideshaker_project.cps").getFile());
